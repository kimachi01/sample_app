...
describe "with non sign in user" do
...
it { expect have_content('5 errors') }
end
end
...
before {click_button submit}
# let(:find_user) { User.find_by(email: "sample@example.com") }
# it { should have_title(find_user.name) }
